...
var HTMLheaderRole = "<span class='blendy-gray-text'>%data%</span><hr/>";
...
var HTMLWelcomeMsg = "<span class='welcome-message blendy-gray-text'>%data%</span>";

var HTMLskillsStart = "<h3 id='skillsH3'>Skills at a Glance:</h3><ul id='skills' class='flex-box'></ul>";  // gets appended to #header and introduced UL with "skills" id for HTMLskills
var HTMLskills = "<li class='flex-item'><span class='blendy-gray-text'>%data%</span></li>"; // the LIs that go into the UL, above... NEAT!
...
var HTMLworkDescription = "<p><br><span class='blendy-gray-text'>%data%</span></p>";

var HTMLprojectStart = "<div class='project-entry'></div>";
var HTMLprojectTitle = "<a href='#'>%data%</a>";
var HTMLprojectDates = "<div class='date-text'>%data%</div>";
var HTMLprojectDescription = "<p><br><span class='blendy-gray-text'>%data%</span></p>";
...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    var lon = placeData.geometry.location.D;  // longitude from the place service. per Dawoon's find, changed from "B" to "D"
